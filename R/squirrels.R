...
#'  \code{0}, while all other elements of \code{branches} may only contain the 
#'  characters given in args \code{left} and \code{right}. E.g. \code{'L'} is 
...
#'  the first branch that forked left off the trunk.
...
#'                       'ChipnDale'), sep='. '))
squirrels <- function(x, branches, pos, left='L', right='R', plot=TRUE, ...) {
